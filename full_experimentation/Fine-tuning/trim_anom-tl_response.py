...
scenario_folder = os.path.join(folder, "data", "anomaly_traffic_light")
...
# only the last question and answer is maintained after trimming. this is the only question adapted to the traffic light anomaly
truck_tl_desc = ['''Inactive traffic light in transport:
...
4. Can this cause the vehicle to make unpredictable or unsafe maneuvers? Yes, an inactive traffic light is unusual and may cause the vehicle to make unsafe maneuvers.
Classification: Anomaly.''', 
'''Traffic light on the back of a truck:
...
4. Can this cause the vehicle to make unpredictable or unsafe maneuvers? Yes, the vehicle may stop in the road which would cause confusion or even an accident.
Classification: Anomaly.''',
'''Truck carrying a traffic light:
...
4. Can this cause the vehicle to make unpredictable or unsafe maneuvers? Yes, the vehicle may stop unnecessarily or become confused by this oddly placed traffic light.
Classification: Anomaly.''', 
'''Traffic light with no signal:
...
4. Can this cause the vehicle to make unpredictable or unsafe maneuvers? Yes, a traffic light normally has a red, yellow or green signal. This traffic light will likely confuse the vehicle.
Classification: Anomaly.''']

ss_billboard_obj = ["\n- Inactive traffic light in transport", "\n- Traffic light on the back of a truck", "\n- Truck carrying a traffic light", "\n- Traffic light with no signal"]
num_anom = 0
